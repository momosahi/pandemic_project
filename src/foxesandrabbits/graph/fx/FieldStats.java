...
class FieldStats {
    ...
    private final HashMap<Class<? extends Animal>, Counter> counters;
    ...
    String getPopulationDetails(Field field) {
        ...
        for (Class<? extends Animal> key : counters.keySet()) {
     ...
     */
    int getPopulationCount(Field field, Class<? extends Animal> key) {
        if (!countsValid) {
            generateCounts(field);
        }
     ...
     */
    void incrementCount(Class<? extends Animal> animalClass) {
